$(function () {
  ...
  var work = new CountUp('work', 0, 50, 0, 4);
  var happyClient = new CountUp('happy-client', 0, 41, 0, 4);
  var projects = new CountUp('projects', 0, 33, 0, 4);
  var coffee = new CountUp('coffee', 0, 41, 0, 4);
